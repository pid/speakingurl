    ...
    var getSlug = function getSlug(input, opts) {
        ...
        for (i = 0, l = input.length; i < l; i++) {
            ...
            if (customChars[ch]) {
                ...
                ch = lastCharWasSymbol && customChars[ch].match(/[\w]/)
                    ? ' ' + customChars[ch]
                    : customChars[ch];
                ...
                ch = lastCharWasSymbol && charMap[ch].match(/[\w]/)
                    ? ' ' + charMap[ch]
                    : charMap[ch];
                ...
                ch = lastCharWasSymbol || result.substr(-1).match(/[\w]/)
                    ? ' ' + symbol[ch]
                    : symbol[ch];
                ...
                if (lastCharWasSymbol && ch.match(/[\w]/)) {
                    ch = ' ' + ch;
                    lastCharWasSymbol = false; // must be inner the if not outer!!!
                }
            }
