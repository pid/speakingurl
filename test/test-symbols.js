...
describe('getSlug symbols', function () {
    it('should convert symbols', function () {
        ...
        getSlug('Foo & Bar | Baz', {lang: 'fr'}).should.eql('foo-and-bar-or-baz');
        getSlug('Foo & Bar | Baz', {lang: 'es'}).should.eql('foo-and-bar-or-baz');
        getSlug('Foo & Bar | Baz', {lang: 'ru'}).should.eql('foo-and-bar-or-baz');
    });
    ...
    it('should not convert symbols with uric flag true', function () {
        ...
        getSlug('Foo & Bar | Baz', {lang: 'fr', uric: true}).should.eql('foo-&-bar-or-baz');
        getSlug('Foo & Bar | Baz', {lang: 'es', uric: true}).should.eql('foo-&-bar-or-baz');
        getSlug('Foo & Bar | Baz', {lang: 'ru', uric: true}).should.eql('foo-&-bar-or-baz');
    });
    ...
    it('should not convert symbols with uricNoSlash flag true', function () {
        ...
        getSlug('Foo & Bar | Baz', {lang: 'fr', uricNoSlash: true}).should.eql('foo-&-bar-or-baz');
        getSlug('Foo & Bar | Baz', {lang: 'es', uricNoSlash: true}).should.eql('foo-&-bar-or-baz');
        getSlug('Foo & Bar | Baz', {lang: 'ru', uricNoSlash: true}).should.eql('foo-&-bar-or-baz');
    });
   ...
   it('should convert symbols with flags true', function () {
        ...
        getSlug('Foo (♥) ; Baz=Bar', {lang: 'de', uric: true, uricNoSlash: true, mark: true}).should.eql('foo-(herz)-;-baz=bar');
        getSlug('Foo (♥) ; Baz=Bar', {lang: 'fr', uric: true, uricNoSlash: true, mark: true}).should.eql('foo-(love)-;-baz=bar');
        getSlug('Foo (♥) ; Baz=Bar', {lang: 'es', uric: true, uricNoSlash: true, mark: true}).should.eql('foo-(love)-;-baz=bar');
        getSlug('Foo (♥) ; Baz=Bar', {lang: 'ru', uric: true, uricNoSlash: true, mark: true}).should.eql('foo-(love)-;-baz=bar');
   });
